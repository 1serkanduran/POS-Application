...
import {useReactToPrint, userReactToPrint} from 'react-to-print'

const PrintBill = ({ isModalOpen, setIsModalOpen, customer }) => {
    const componentRef =useRef();

    const handelePrint=useReactToPrint({
    ...
    return (
        <Modal title="Fatura Yazdır" open={isModalOpen} footer={false} onCancel={() => setIsModalOpen(false)} width={800}>
            ...
            <div className="flex justify-end mt-4">
                <Button type="primary" size="large" onClick={handelePrint}>Yazdır</Button>
            </div>
        </Modal>
    )
}
